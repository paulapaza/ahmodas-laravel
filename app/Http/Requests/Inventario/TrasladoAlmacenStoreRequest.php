...
class TrasladoAlmacenStoreRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'traslados.*.stock_disponible' => 'required|integer|min:1',
            
            // Auditoría (Opcional pero recomendado validar si se envían)
    ...
    public function messages(): array
    {
        return [
            ...
            'traslados.*.stock_enviado.min' => 'La cantidad a trasladar debe ser al menos 1.',
        ];
    }
}
