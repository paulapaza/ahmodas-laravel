<x-admin-layout>
  ...
  <x-slot name="pagetitle">Tipos de Precio - Catálogo No. 11: Resumen diario de boletas de venta y notas electrónicas - Código de tipo de valor de
    venta</x-slot>
...
<script>
    $(document).ready(function() {
        ...
        let dataCrud = {
            route: "/facturacion/tipo-precio",
            subject: 'Tipo de precio',
            model: "TipoPrecio",
            csrf: csrf,
        };
