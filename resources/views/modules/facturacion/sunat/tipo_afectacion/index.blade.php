<x-admin-layout>
  ...
  <x-slot name="pagetitle">Tipo de Afectacio - catalogo 07 SUNAT</x-slot>
...
<script>
    $(document).ready(function() {
        ...
        let dataCrud = {
            route: "/facturacion/tipo-afectacion-igv",
            subject: 'Tipo de Afectacion', // Nombre de botones ejemplo crear...
            model: "Marca02",
            csrf: csrf,
        };
